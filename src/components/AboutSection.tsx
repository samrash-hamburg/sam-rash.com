...
const milestones = [
  { icon: Disc3, title: "100+ Events", description: "Worldwide performances" },
  { icon: Globe, title: "20+ Countries", description: "International tours" },
  { icon: Award, title: "5 Awards", description: "Industry recognition" },
  { icon: Music, title: "50+ Releases", description: "Original tracks & remixes" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {milestones.map((milestone, index) => (
              <div
                key={milestone.title}
                className="bg-secondary/50 border border-border rounded-lg p-6 hover:border-primary/50 hover:shadow-[0_0_20px_hsl(190_100%_50%/0.2)] transition-all duration-300 group"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <milestone.icon className="w-8 h-8 text-primary mb-4 group-hover:animate-glow-pulse" />
